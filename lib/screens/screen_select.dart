...
class ScreenSelect extends StatelessWidget {
  ...
  void _addList() {
    ...
    modelExam = new ModelExam('PAI 성격평가질문지_일반[증보판] 문항', {
      "key": "김철수PA|M|20000505|010-1234-1234|xodyd2425@hakjisa.co.kr|인싸이트||AT_S_0001|2000|PAIR_CO_SG|MEM00000000000050182|심리검사센터|",
      "addInquiry" : "자영업|미혼"
    });
    list.add(modelExam);
    ...
    modelExam = new ModelExam('KPSI4 한국판 부모 양육스트레스 검사 문항', {
      "key":"김철수KI|M|20000101|010-1234-1234|xodyd2425@hakjisa.co.kr|인싸이트|| | |KPSI4_CO_PG|MEM00000000000050182|심리검사센터|",
      "addInquiry":"미혼|부|김자녀|여|만 4세"
    });
    list.add(modelExam);

    modelExam = new ModelExam('PCT 부모양육특성 검사 문항', {
      "key":"김철수P|M|20020125|010-1234-1234|xodyd2425@hakjisa.co.kr|인싸이트|| | |PCT_CO_PG|MEM00000000000050182|심리검사센터|",
      "addInquiry":"아동의 발달문제|연락처 및 이메일|작성자 이름|아동과의 관계|부 연령|부 직업|모 연령|모 직업|부 학력|모 학력"
    });
    list.add(modelExam);

    modelExam = new ModelExam('KPRQ 아동청소년용 부모자녀관계검사 문항', {
      "key":"김철수KQ|M|20040125|010-1234-1234|xodyd2425@hakjisa.co.kr|인싸이트||AT_S_0006|2050|KPRQ_CO_PG_CA|MEM00000000000050182|심리검사센터|",
      "addInquiry":"김철수KQ|부"
    });
    list.add(modelExam);

    modelExam = new ModelExam('KPRQ 유아용 부모자녀관계검사 문항', {
      "key":"김철수KQ|M|20180103|010-1234-1234|xodyd2425@hakjisa.co.kr|인싸이트|| | |KPRQ_CO_PG_P|MEM00000000000050182|심리검사센터|",
      "addInquiry":"김철수KQ|부"
    });
    list.add(modelExam);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Color(0xfff4f4f4),
        appBar: AppBar(
          centerTitle: true,
          title: Text('Sample 검사선택',style: TextStyle(color: Colors.black87),),
        ),
